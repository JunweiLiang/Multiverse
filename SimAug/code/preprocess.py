...
def prepro_each(traj_path, split, prepro_path, args):
  ...
  seq_key_list = []  # [N], each is a key of videoname_frameidx_personid
  vid2name = {}
  total_frame_used = {}
      ...
      for person_id in persons_in_cur_seq:
        ...
        if args.add_grid:
          ...
          for i, (center, (h, w)) in enumerate(zip(
            ...
            #print(x_indexes, frame_idxs, videoname, person_id)
        ...
        # add the seq_key
        cur_seq_ids.append("%s_%d_%d" % (videoname, frame_idxs[0], person_id))
        count_person += 1
